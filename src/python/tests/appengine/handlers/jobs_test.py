...
class JobsTest(unittest.TestCase):
  ...
  def test_get_results(self):
    ...
    job1 = self._create_job('test_job1', 'APP_NAME = launcher.py\n')
    job2 = self._create_job('test_job2', 'APP_NAME = launcher.py\n')
    job3 = self._create_job('test_job3', 'APP_NAME = launcher.py\n')
    job4 = self._create_job('test_job4', 'APP_NAME = launcher.py\n')
